...
（Ubuntu などでも構いませんが，後述するインストーラは Debian にしか対応していないので，
積極的に苦労したい人以外は Debian を使うと良いです．）

#### 環境構築

https://github.com/akabe/setup に書いてあるとおりに，必要な環境をインストールします．
LaTeX 以外にも，OCaml，OPAM，Emacs などの必要なものがひと通り揃います．
インストール作業にはおよそ数時間かかります．
...
で OMake をインストールした後，スライドのディレクトリ `slide/` もしくは論文のディレクトリ `paper/` の下で，
